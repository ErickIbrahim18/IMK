						...
						<div class="panel-body">
							<div class="row">
							  ...
							  <div class="form-group">
							    ...
							    <input type="text" class="form-control" name="nisn" id="nisn" aria-describedby="emailHelp" required>
							  </div>
							  <div class="form-group">
							  ...
							  <div class="form-group">
							    ...
							    <input type="text" class="form-control" name="jurusan" id="jurusan" aria-describedby="emailHelp" required>
							  </div>
							  <div class="form-group">
							    <label for="gambar">Gambar  </label>
							    <input type="file" class="form-control" name="gambar" id="gambar" aria-describedby="emailHelp" required>
							  </div>
